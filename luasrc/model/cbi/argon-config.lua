--  place in : / usr / lib / lua / luci / model / cbi
...
if nxfs.access('/etc/config/argon') then
	...
	gradient_start = uci:get_first('argon', 'global', 'gradient_start')
	gradient_end = uci:get_first('argon', 'global', 'gradient_end')
	dark_primary = uci:get_first('argon', 'global', 'dark_primary')
	dark_gradient_start = uci:get_first('argon', 'global', 'dark_gradient_start')
	dark_gradient_end = uci:get_first('argon', 'global', 'dark_gradient_end')
	...
	background_color = uci:get_first('argon', 'global', 'background_color')
end
...
o = s:option(ListValue, 'bing_background', translate('Background'))
o:value('0', translate('Built-in'))
o:value('1', translate('Bing Wallpapers'))
o:value('2', translate('Solid Color'))
o.default = bing_background
o.rmempty = false

o = s:option(Value, 'background_color', translate('Background color'), translate('A HEX Color ; ( Default: #222222 )'))
o.default = background_color
o.datatype = ufloat
o.rmempty = false
...
o = s:option(Value, 'gradient_start', translate('[Light mode] gradient start color'), translate('A HEX Color ; ( Default: #5e72e4 )'))
o.default = gradient_start
o.datatype = ufloat
o.rmempty = false

o = s:option(Value, 'gradient_end', translate('[Light mode] gradient end color'), translate('A HEX Color ; ( Default: #5e72e4 )'))
o.default = gradient_end
o.datatype = ufloat
o.rmempty = false
...
o = s:option(Value, 'dark_gradient_start', translate('[Dark mode] gradient start color'), translate('A HEX Color ; ( Default: #5e72e4 )'))
o.default = dark_gradient_start
o.datatype = ufloat
o.rmempty = false

o = s:option(Value, 'dark_gradient_end', translate('[Dark mode] gradient end color'), translate('A HEX Color ; ( Default: #5e72e4 )'))
o.default = dark_gradient_end
o.datatype = ufloat
o.rmempty = false
